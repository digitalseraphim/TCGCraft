...
//			EntityItem entity = (EntityItem) data[1];
	...
	public void renderFirstPerson(EntityPlayer player, RenderBlocks render){
       ...
       float f7 = player.getSwingProgress(0);
       ...
       float f6 = MathHelper.sin(MathHelper.sqrt_float(f7) * (float)Math.PI);
        ...
        float f11 = 0.015625F;
        GL11.glScalef(f11, f11, f11);
        render.minecraftRB.getTextureManager().bindTexture(new ResourceLocation("tcgc:textures/items/card_front_base.png"));
